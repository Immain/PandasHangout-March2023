      ...
      <section className="dark:bg-neutral py-16">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-black-400 dark:text-green-400 text-green-400 xxs:text-center lg:text-left">
              LIVE STREAMS
            </h2>
            <h1 className="text-3xl dark:text-white text-black mb-4 tracking-tight font-extrabold xxs:text-center lg:text-left">
              Catch us live on Panda's Hangout for Movie Nights, Game Nights,
              and more!
            </h1>
            <p class="mb-4 dark:text-white text-black xxs:text-center lg:text-left">
            ...
            <p className="mb-4 dark:text-white text-black xxs:text-center lg:text-left">
