...
const Servers = () => {
  return (
    <section className="xxs:py-16 xxs:px-10 lg:px-0 lg:py-0 xxs:dark:bg-neutral bg-white lg:pb-10 lg:bg-transparent">
      <video
        src={gaming}
        autoPlay
        loop
        muted
        className="lg:w-full lg:h-full object-cover absolute -z-10 brightness-50 xxs:w-[200px] invisible lg:visible"
      />
      ...
      <div className="grid lg:grid-cols-2 xxs:grid-cols-1 xxxs:grid-col-1 mt-8 mx-auto max-w-[1240px] gap-6 ">
        {/* Card 1 */}
        <div className="card lg:w-[450px] dark:bg-base-100 bg-white border-2 dark:border-none shadow-md shadow-green-400 lg:mx-auto xxs:w-70">
          <figure>
            <img
        ...
        {/* Card 2 */}
        <div className="card lg:w-[450px] dark:bg-base-100 bg-white shadow-md shadow-yellow-300 border-2 dark:border-none lg:mx-auto xxs:w-70">
          <figure>
            <img
