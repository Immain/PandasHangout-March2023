...
const Toc = () => {
  return (
    <div className="bg-gray-800">
      <Navbar />
      <div className="text-white max-w-[1240px] mx-auto space-y-5 p-4">
        <h1 className="text-3xl font-bold text-green-400">
          Terms of Service For Panda's Hangout
        </h1>
        ...
        <p>
          ...
          conditions. Do not continue to use Panda's Hangout if you do not agree
        ...
        <h3 className="text-3xl font-bold text-green-400">License</h3>

        <p>
          Unless otherwise stated, High Sierra Software and/or its licensors own
          the intellectual property rights for all material on Panda's Hangout.
          All intellectual property rights are reserved. You may access this
          from Panda's Hangout for your own personal use subjected to
          restrictions set in these terms of service.
        </p>

        <p>You must not:</p>
        <ul className="list-disc p-4 space-y-2 list-inside">
          <li>Republish material from Panda's Hangout</li>
          <li>Sell, rent or sub-license material from Panda's Hangout</li>
          <li>Reproduce, duplicate or copy material from Panda's Hangout</li>
          <li>Redistribute content from Panda's Hangout</li>
        </ul>

        <p>
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website.
          High Sierra Software does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of High Sierra Software,its agents and/or
          ...
          laws, High Sierra Software shall not be liable for the Comments or for
        ...
        <p>
          High Sierra Software reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant High Sierra Software a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of High Sierra Software; and (d)
        ...
        <p>
          ...
          sending an e-mail to High Sierra Software. Please include your name,
        ...
        <p>
          No use of High Sierra Software's logo or other artwork will be allowed
          for linking absent a trademark license agreement.
        </p>

        <h3 className="text-3xl font-bold text-green-400">iFrames</h3>
        ...
        <h3 className="text-3xl font-bold text-green-400">Content Liability</h3>
        ...
        <h3 className="text-3xl font-bold text-green-400">Your Privacy</h3>

        <p>
          Please read our{" "}
          <Link
            to="/legal/privacy-policy"
            className="text-green-300 hover:text-green-700 underline"
          >
            Privacy Policy.
          </Link>
        </p>
        ...
        <p>
          ...
          you are free to contact and inform us at any moments notice. We will
        ...
        <h3 className="text-3xl font-bold text-green-400">Disclaimer</h3>
