    ...
    <div className="mx-auto px-4 py-16 bg-white text-black dark:text-white text-center dark:bg-neutral border-t border-green-400">
      <div className="max-w-[1240px] mx-auto px-4 grid grid-cols-2 lg:grid-cols-5 gap-y-4">
        <div className="col-span-2 lg:col-span-1">
          ...
          <p className="pt-2">
            ...
            and positive interactions while watching fun gameplay and unique
            stream events!
          </p>
          <div className="pt-5 inline-block space-x-2">
            ...
            <button className="rounded-full w-15 h-15 py-2 p-2 hover:text-purple-400">
              <a href="https://www.twitch.tv/king_pandakp">
                <SiTwitch size={20} />
              </a>
            </button>
            <button className="rounded-full w-15 h-15 py-2 p-2 hover:text-amber-400">
              <a href="https://www.buymeacoffee.com/pdstech">
          ...
          <div>
            <h1 className="pt-2 font-semibold">
              LGBTQ+ Friendly 🌈{" "}
              <RiHeart2Fill size={20} className="inline-block text-red-500" />
            </h1>
          </div>
        </div>
        <div>
          <h3 className="font-bold text-xl border-b-4 border-green-400 inline-block dark:text-white text-black">
            QUICK LINKS
          </h3>
          <ul className="pt-5 dark:text-white text-black">
            ...
            <Link to="/about">
              <li className="py-2 hover:text-green-400 cursor-pointer">
                About
              </li>
            </Link>
            <Link to="/live">
        ...
        <div>
          <h3 className="font-bold text-xl border-b-4 border-green-400 inline-block text-black dark:text-white">
            SUPPORT
          </h3>
          <ul className="pt-5 dark:text-white text-black">
      ...
      <div className="content-center space-y-1 pt-2">
        ...
        <p className="text-sm inline-flex">
          Made with{" "}
          <span className="text-red-500 pt-1 px-1">
